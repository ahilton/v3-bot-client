...
package org.bttf.v3client.model;
...
import org.bttf.v3client.model.Attachment;
import org.bttf.v3client.model.ChannelAccount;
import org.bttf.v3client.model.ConversationAccount;
import org.bttf.v3client.model.ConversationReference;
import org.bttf.v3client.model.Entity;
import org.bttf.v3client.model.SuggestedActions;
...
@javax.annotation.Generated(value = "class io.swagger.codegen.languages.JavaClientCodegen", date = "2017-10-14T23:35:59.935+11:00")
public class Activity   {
   ...
   * @return type
  **/
  @ApiModelProperty(example = "null", value = "The type of the activity [message|contactRelationUpdate|converationUpdate|typing|endOfConversation|event|invoke]")
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "ID of this activity")
  public String getId() {
    return id;
  }
  ...
  **/
   ...
   * @return serviceUrl
  **/
  @ApiModelProperty(example = "null", value = "Service endpoint where operations concerning the activity may be performed")
   ...
   * @return channelId
  **/
  @ApiModelProperty(example = "null", value = "ID of the channel where the activity was sent")
  ...
  **/
  @ApiModelProperty(example = "null", value = "Hint for how to deal with multiple attachments: [list|carousel] Default:list")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True if the previous history of the channel is disclosed")
  ...
  **/
   ...
   * @return speak
  **/
  @ApiModelProperty(example = "null", value = "SSML Speak for TTS audio response")
   ...
   * @return inputHint
  **/
  @ApiModelProperty(example = "null", value = "Indicates whether the bot is accepting, expecting, or ignoring input")
   ...
   * @return summary
  **/
  @ApiModelProperty(example = "null", value = "Text to display if the channel cannot render cards")
  ...
  **/
  @ApiModelProperty(example = "null", value = "SuggestedActions are used to provide keyboard/quickreply like behavior in many clients")
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "Name of the operation to invoke or the name of the event")
   ...
   * @return relatesTo
  **/
  @ApiModelProperty(example = "null", value = "Reference to another conversation or activity")
   ...
   * @return code
  **/
  @ApiModelProperty(example = "null", value = "Code indicating why the conversation has ended")

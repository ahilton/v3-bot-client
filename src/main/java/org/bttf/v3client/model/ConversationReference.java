...
public class ConversationReference   {
   ...
   * @return activityId
  **/
  @ApiModelProperty(example = "null", value = "(Optional) ID of the activity to refer to")
   ...
   * @return user
  **/
  @ApiModelProperty(example = "null", value = "(Optional) User participating in this conversation")
   ...
   * @return bot
  **/
  @ApiModelProperty(example = "null", value = "Bot participating in this conversation")
   ...
   * @return conversation
  **/
  @ApiModelProperty(example = "null", value = "Conversation reference")
   ...
   * @return channelId
  **/
  @ApiModelProperty(example = "null", value = "Channel ID")
   ...
   * @return serviceUrl
  **/
  @ApiModelProperty(example = "null", value = "Service endpoint where operations concerning the referenced conversation may be performed")

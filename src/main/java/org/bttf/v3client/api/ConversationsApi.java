...
package org.bttf.v3client.api;

import org.bttf.v3client.ApiCallback;
import org.bttf.v3client.ApiClient;
import org.bttf.v3client.ApiException;
import org.bttf.v3client.ApiResponse;
import org.bttf.v3client.Configuration;
import org.bttf.v3client.Pair;
import org.bttf.v3client.ProgressRequestBody;
import org.bttf.v3client.ProgressResponseBody;
...
import org.bttf.v3client.model.ResourceResponse;
...
public class ConversationsApi {
    ...
    private com.squareup.okhttp.Call conversationsGetActivitiesCall(String conversationId, String watermark, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ActivitySet conversationsGetActivities(String conversationId, String watermark) throws ApiException {
        ApiResponse<ActivitySet> resp = conversationsGetActivitiesWithHttpInfo(conversationId, watermark);
        return resp.getData();
    }
    ...
    public ApiResponse<ActivitySet> conversationsGetActivitiesWithHttpInfo(String conversationId, String watermark) throws ApiException {
        com.squareup.okhttp.Call call = conversationsGetActivitiesCall(conversationId, watermark, null, null);
     ...
     */
    public com.squareup.okhttp.Call conversationsGetActivitiesAsync(String conversationId, String watermark, final ApiCallback<ActivitySet> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = conversationsGetActivitiesCall(conversationId, watermark, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ActivitySet>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for conversationsPostActivity */
    private com.squareup.okhttp.Call conversationsPostActivityCall(String conversationId, Activity activity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<ResourceResponse> conversationsPostActivityWithHttpInfo(String conversationId, Activity activity) throws ApiException {
        com.squareup.okhttp.Call call = conversationsPostActivityCall(conversationId, activity, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call conversationsPostActivityAsync(String conversationId, Activity activity, final ApiCallback<ResourceResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = conversationsPostActivityCall(conversationId, activity, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for conversationsReconnectToConversation */
    private com.squareup.okhttp.Call conversationsReconnectToConversationCall(String conversationId, String watermark, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public Conversation conversationsReconnectToConversation(String conversationId, String watermark) throws ApiException {
        ApiResponse<Conversation> resp = conversationsReconnectToConversationWithHttpInfo(conversationId, watermark);
        return resp.getData();
    }
    ...
    public ApiResponse<Conversation> conversationsReconnectToConversationWithHttpInfo(String conversationId, String watermark) throws ApiException {
        com.squareup.okhttp.Call call = conversationsReconnectToConversationCall(conversationId, watermark, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call conversationsReconnectToConversationAsync(String conversationId, String watermark, final ApiCallback<Conversation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = conversationsReconnectToConversationCall(conversationId, watermark, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for conversationsStartConversation */
    private com.squareup.okhttp.Call conversationsStartConversationCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Conversation> conversationsStartConversationWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = conversationsStartConversationCall(null, null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call conversationsStartConversationAsync(final ApiCallback<Conversation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = conversationsStartConversationCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for conversationsUpload */
    private com.squareup.okhttp.Call conversationsUploadCall(String conversationId, File file, String userId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (file == null) {
            throw new ApiException("Missing the required parameter 'file' when calling conversationsUpload(Async)");
        }
    ...
    public ResourceResponse conversationsUpload(String conversationId, File file, String userId) throws ApiException {
        ApiResponse<ResourceResponse> resp = conversationsUploadWithHttpInfo(conversationId, file, userId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceResponse> conversationsUploadWithHttpInfo(String conversationId, File file, String userId) throws ApiException {
        com.squareup.okhttp.Call call = conversationsUploadCall(conversationId, file, userId, null, null);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call conversationsUploadAsync(String conversationId, File file, String userId, final ApiCallback<ResourceResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = conversationsUploadCall(conversationId, file, userId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }

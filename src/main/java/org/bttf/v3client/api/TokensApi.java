...
import org.bttf.v3client.model.TokenParameters;
...
public class TokensApi {
    ...
    private com.squareup.okhttp.Call tokensGenerateTokenForNewConversationCall(TokenParameters tokenParameters, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = tokenParameters;
        

        // create path and map variables
        String localVarPath = "/v3/directline/tokens/generate".replaceAll("\\{format\\}","json");
    ...
    public Conversation tokensGenerateTokenForNewConversation(TokenParameters tokenParameters) throws ApiException {
        ApiResponse<Conversation> resp = tokensGenerateTokenForNewConversationWithHttpInfo(tokenParameters);
        return resp.getData();
    }
    ...
    public ApiResponse<Conversation> tokensGenerateTokenForNewConversationWithHttpInfo(TokenParameters tokenParameters) throws ApiException {
        com.squareup.okhttp.Call call = tokensGenerateTokenForNewConversationCall(tokenParameters, null, null);
     ...
     */
    public com.squareup.okhttp.Call tokensGenerateTokenForNewConversationAsync(TokenParameters tokenParameters, final ApiCallback<Conversation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = tokensGenerateTokenForNewConversationCall(tokenParameters, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /* Build call for tokensRefreshToken */
    private com.squareup.okhttp.Call tokensRefreshTokenCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/v3/directline/tokens/refresh".replaceAll("\\{format\\}","json");
    ...
    public Conversation tokensRefreshToken() throws ApiException {
        ApiResponse<Conversation> resp = tokensRefreshTokenWithHttpInfo();
        return resp.getData();
    }
    ...
    public ApiResponse<Conversation> tokensRefreshTokenWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = tokensRefreshTokenCall(null, null);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call tokensRefreshTokenAsync(final ApiCallback<Conversation> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = tokensRefreshTokenCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Conversation>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
